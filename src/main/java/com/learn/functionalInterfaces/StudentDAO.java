...
public class StudentDAO {
    ...
    public static List<Student> getAllStudents(){
         ...
         * 3rd grade students
         */
        Student student3 = new Student("Emily",3,4.0,"female",15, Arrays.asList("swimming", "gymnastics","aerobics"));
        Student student4 = new Student("Dave",3,3.9,"male",9, Arrays.asList("swimming", "gymnastics","soccer"));

        /**
         * 4th grade students
         */
        Student student5 = new Student("Sophia",4,3.5,"female", 13,Arrays.asList("swimming", "dancing","football"));
